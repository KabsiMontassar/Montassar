...
const SettingsPanel = ({ isOpen, onToggle, language, onLanguageChange }) => {
  ...
  return (
    <>
      <button
        ...
        style={{ zIndex: 20 }}
      >
        <span className="text-2xl text-primary group-hover:text-secondary transition-colors">
         <IoSettings  width={24} height={24} />
        </span>
      </button>
      {isOpen && (
        <div
