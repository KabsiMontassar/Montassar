...
const Chevrons = () => {
  ...
  const getTransform = () => {
    switch (animationPhase) {
      case 'scaling':
        return 'translate3d(0px, 0px, 0px) scale3d(1.25, 0.75, 1) rotateX(0deg) rotateY(0deg) rotateZ(0deg) skew(2deg, 0deg)';
      case 'bounce':
        return 'translate3d(0px, 2px, 0px) scale3d(0.9, 1.1, 1) rotateX(0deg) rotateY(0deg) rotateZ(0deg) skew(-1deg, 0deg)';
      case 'returningfirst':
        return 'translate3d(0px, -1px, 0px) scale3d(1.05, 0.95, 1) rotateX(0deg) rotateY(0deg) rotateZ(0deg) skew(0.5deg, 0deg)';
      case 'returning':
