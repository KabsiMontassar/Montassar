  ...
  return (
    <div className="relative w-full min-h-screen bg-gradient-to-br from-purple-900 via-violet-900 to-fuchsia-900 flex items-center justify-center">
      <div className="text-center text-white max-w-4xl mx-auto px-6">
        ...
        >
          <motion.h1
            className="text-6xl md:text-8xl font-bold bg-gradient-to-r from-purple-400 to-fuchsia-400 bg-clip-text text-transparent"
            initial={{ scale: 0.5 }}
            animate={{ scale: 1 }}
          ...
          >
            Developing robust, scalable server-side solutions and APIs
          </motion.p>
          ...
          >
            {['Python', 'Django', 'PostgreSQL', 'Redis', 'Docker'].map((tech, index) => (
              <span
                key={tech}
