...
const WorkSection = ({ currentSlide = 0, sectionIndex = 0 }) => {
    ...
    return (
        <div className={`relative w-full min-h-screen overflow-hidden ${isBlackVariant
            ...
            <div className="relative z-10 gap-100 flex flex-col lg:flex-row items-center justify-center min-h-screen px-4 sm:px-6 lg:px-8 xl:px-12 py-8 lg:py-0">
                ...
                <div className="flex-1 flex flex-col justify-center items-start space-y-6 lg:space-y-8 max-w-lg mb-8 lg:mb-0 lg:ml-16 xl:ml-24">
                    ...
                    <motion.div
                        ...
                        className="ml-6 space-y-3 inline-block"
                    >
